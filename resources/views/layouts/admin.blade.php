        ...
        <div class="w-64  shadow-xl flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6">
                <div class="space-y-1">
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('admins.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-400 hover:bg-blue-500 hover:text-white rounded-xl transition-all duration-200 group {{ request()->routeIs('admins.dashboard') ? 'bg-blue-600 text-white shadow-lg' : '' }}">
                        ...
                        <li>
                            <a href="{{ route('admins.properties') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-400 hover:bg-blue-500 hover:text-white rounded-xl transition-all duration-200 group {{ request()->routeIs('admins.properties*') ? 'bg-blue-600 text-white shadow-lg' : '' }}">
                                <div class="w-6 h-6 flex items-center justify-center">
                        ...
                        <li>
                            <a href="{{ route('admins.maintenance') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-400 hover:bg-blue-500 hover:text-white rounded-xl transition-all duration-200 group {{ request()->routeIs('admins.maintenance*') ? 'bg-blue-600 text-white shadow-lg' : '' }}">
                                <div class="w-6 h-6 flex items-center justify-center">
                        ...
                        <li>
                            <a href="{{ route('admins.analytics') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-400 hover:bg-blue-500 hover:text-white rounded-xl transition-all duration-200 group {{ request()->routeIs('admins.analytics*') ? 'bg-blue-600 text-white shadow-lg' : '' }}">
                                <div class="w-6 h-6 flex items-center justify-center">
